...
INSTALLED_APPS = [
    'daphne',  # Channels ASGI server (must be first for WebSocket support)
...
SARVAM_AI_MODEL = config('SARVAM_AI_MODEL', default='saarika:v2.5')

# JioTV Configuration
JIOTV_API_URL = config('JIOTV_API_URL', default='http://localhost:8000')
JIOTV_MOBILE = config('JIOTV_MOBILE', default='')
JIOTV_PASSWORD = config('JIOTV_PASSWORD', default='')
JIOTV_CACHE_TIMEOUT = config('JIOTV_CACHE_TIMEOUT', default=21600, cast=int)
JIOTV_TOKEN_EXPIRY = config('JIOTV_TOKEN_EXPIRY', default=82800, cast=int)
